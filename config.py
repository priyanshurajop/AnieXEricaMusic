...
OWNER_ID = int(getenv("OWNER_ID", 6634748952))
OWNER = int(getenv("OWNER", 5360305806))
OWNER_USERNAME = getenv("OWNER_USERNAME","DevilCoder")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/priyanshurajop/AnieXEricaMusic")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN",None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/DEVILFEDLOGS")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/DEVILFEDCHAT")
